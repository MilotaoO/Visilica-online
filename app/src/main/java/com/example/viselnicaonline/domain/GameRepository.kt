...
interface GameRepository {
    ...
    fun observeGame(gameId: String): kotlinx.coroutines.flow.Flow<Game?>
    ...
    suspend fun fetchGameOnce(gameId: String): Result<Game?>
    ...
    fun observeOpenGames(): kotlinx.coroutines.flow.Flow<List<Game>>
